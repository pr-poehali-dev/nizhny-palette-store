      ...
      <div className="max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: "0.8s" }}>
          ...
          <Button
            variant="outline"
            size="lg"
            className="border-foreground/20 text-foreground hover:bg-foreground/5 px-8 py-6 text-sm tracking-wide"
          >
            Собрать свой Нижний
          </Button>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-muted-foreground font-light leading-relaxed mb-8">
            ...
            привязанное к месту. Волжская глубина, печёрский мёд, закат на откосе — не абстракция,
            а конкретная точка на карте, конкретная минута дня.
          </p>
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            <span className="px-4 py-1.5 text-muted-foreground text-xs tracking-wide">
              +{FEELINGS.length - 8} чувств
            </span>
          </div>
        ...
        <div className="relative">
          <img
            src={COLLECTION_IMG}
            alt="Коллекция Нижегородские краски"
            className="w-full rounded-sm shadow-2xl shadow-foreground/10"
          />
          <div className="absolute -bottom-6 -left-6 bg-background p-6 rounded-sm shadow-lg">
            <p className="font-heading text-3xl font-light">40</p>
            <p className="text-xs text-muted-foreground tracking-wide">уникальных оттенков</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center">
          <p className="text-sm text-muted-foreground mb-4">
            Выбрано: {selected.length} из 8 оттенков
          </p>
          <Button className="bg-primary text-primary-foreground hover:bg-primary/90 px-8">
            Оформить набор — от 3 200 ₽
          </Button>
        </div>
      </div>
    </section>
    ...
    <div className="max-w-4xl mx-auto px-6">
      ...
      <div className="space-y-12">
        {[
          {
            year: "Земля",
            title: "Дятловы горы и кремлёвский кирпич",
            text: "Нижний стоит на известняке и глине. Бежевый, терракотовый, охристый — это не выбор, а данность. Город буквально построен из своей палитры.",
          },
          {
            year: "Вода",
            title: "Волга и Ока, две реки — два характера",
            text: "Тёмная волжская синева и светлая окская зелень. На Стрелке они встречаются, но не смешиваются — как два голоса в одной песне.",
          },
          {
            year: "Небо",
            title: "Закаты средней полосы",
            text: "Нижегородское небо — это отдельная палитра. Персиковые рассветы, лиловые сумерки, медовый свет на откосе. Город, который смотрит на закат сверху вниз.",
          },
        ].map((item, i) => (
        ...
        <div className="bg-card rounded-sm p-8">
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3 bg-background border border-border rounded-sm text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20 transition-shadow"
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-background border border-border rounded-sm text-sm focus:outline-none focus:ring-1 focus:ring-foreground/20 transition-shadow resize-none"
            />
